...
nmap <silent> <leader>ll    <Plug>LocationNext
...
nmap <silent> <C-m>    <Plug>QuickfixPrevious
nmap <silent> <C-n>    <Plug>QuickfixNext
nmap <silent> <leader>a :cclose<CR>
